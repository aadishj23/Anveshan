    ...
    return (
        ...
        >
            <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 invisible md:visible md:pt-60 ">
                ...
                <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-orange-400 opacity-50 blur-3xl"></div>
                <motion.div
                    initial={{ width: "8rem" }}
            ...
            <div className="relative z-50 flex -translate-y-30 flex-col items-center px-5 mb-10 md:mb-20 mt-40 md:-mt-5 lg:-mt-10">
                {children}
            </div>
        </div>
    );
