    ...
    return (
        <div className="min-h-screen bg-black">
            ...
            <p className="text-white text-center mx-auto w-4/5 md:w-3/5">
                Meet Your Alumni is a special event by Anveshan, designed to connect BPIT students
                with accomplished alumni for invaluable career guidance. Recently, we hosted Mr.
                Sawarnee Sethi, a Cloud Engineer at AWS, who shared his expertise on Internships and
                Placements.In this session, Mr. Sethi offered strategies for navigating the
                internship and placement process, preparing for interviews, and building a standout
                profile. With his firsthand industry insights, students gained practical knowledge
                on transitioning from academic life to a successful tech career.
            </p>
