    ...
    return (
        <div className="min-h-screen bg-black">
            ...
            <p className="text-white text-center mx-auto w-4/5 md:w-3/5">
                ...
                Preparation led by Mr. Gurupal Singh Chawla, a renowned GATE educator at Unacademy.
                This event provided students with essential insights into the GATE examination,
                covering preparation strategies, study resources, and tips for excelling in one of
                the most competitive exams in India.Mr. Chawla shared his expertise on effective
                time management, key areas to focus on, and how to approach complex topics, giving
                attendees a solid foundation for their GATE journey. The session was an excellent
                opportunity for students to gain guidance from a leading educator and enhance their
