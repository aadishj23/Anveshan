    ...
    return (
        <div className="min-h-screen bg-black pb-10">
            ...
            <p className="text-white text-center mx-auto w-4/5 md:w-3/5">
                Tech Starter is Anveshan's month-long foundational cohort, specially designed to
                equip students with essential skills across core tech domains. Led by our Core Team
                members, this immersive program included hands-on sessions on HTML & CSS, Git and
                GitHub, JavaScript, C++, Java, and an Introduction to Data Structures and
                Algorithms.Each session was crafted to provide a practical, beginner-friendly
                approach, allowing students to build confidence and solidify their understanding of
                these foundational topics. Tech Starter empowers participants with the knowledge and
                skills they need to embark on their tech journeys, whether they're diving into web
                development, coding fundamentals, or programming logic.
            </p>
