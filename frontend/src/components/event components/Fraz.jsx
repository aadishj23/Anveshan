...
function Fraz() {
  return (
    <div className="min-h-screen bg-black">
      ...
      <p className="text-white text-center mx-auto w-4/5 md:w-3/5">Anveshan had the pleasure of hosting Mohammad Fraz, a Software Engineer at Google and a popular YouTuber known for his tech content. This engaging session was filled with engineering tips that ranged from optimizing study habits and managing time effectively to enhancing technical skills and preparing for the tech industry.Fraz shared practical advice on succeeding as an engineering student and offered insights from his journey into the tech field. With his background as both a Google engineer and content creator, he provided students with a unique perspective on building a career, balancing personal projects, and developing a solid foundation for long-term success in tech.</p>
