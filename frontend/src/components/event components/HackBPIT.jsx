...
function HackBPIT() {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <p className="text-white text-center mx-auto md:w-3/5 p-5">HackBPIT, the flagship hackathon of BPIT, is where innovative ideas meet real-world problem-solving! Hosted by Anveshan, HackBPIT 2023 drew an impressive 100+ teams from across the country, all competing for a total prize pool of 1 Lakh with <b>50k Cash Prize</b>. This high-energy, 30-hour offline event brought together students, industry mentors, and tech enthusiasts to collaborate, create, and build impactful solutions.Participants faced challenging problem statements across multiple domains, encouraging them to think critically and work together under pressure. The event was not just about coding; it was a platform for learning, mentorship, and networking, offering valuable insights and connections for every attendee.</p>
      ...
      <div className="flex flex-col space-y-4 md:flex-row items-center justify-around p-5 lg:p-20">
        <img src={Poster} alt="HackBPIT 2k23 Poster" className=" h-[350px] lg:h-[500px] rounded-lg" />
        <img src={Stage2} alt="HackBPIT 2k23 Stage Photo 2" className="w-4/5 md:w-3/5 h-auto rounded-lg" />
      </div>
      ...
      <div className='p-0 md:p-10 lg:p-20'>
        <Slider {...settings} >
          <img src={Judge1} alt="HackBPIT 2k23 Judge Sawarnee Sethi" className="w-1/3 rounded-lg" />
