                            ...
                            i % 2 === 0 && (
                                <div key={i} className="flex flex-col">
                                    ...
                                    {ProjectsData[i + 1] && (
                                        <div className="flex space-x-5">
                                            <ProjectCard2
                                                image={ProjectsData[i + 1].image}
                                                work={ProjectsData[i + 1].Work}
                                                description={ProjectsData[i + 1].description}
                                            />
                                            <Projectscard
                                                vis={visual2}
                                                name={ProjectsData[i + 1].name}
                                                GithubRepo={ProjectsData[i + 1].GithubRepo}
                                                Deployment={ProjectsData[i + 1].Deployment}
                                                owner={ProjectsData[i + 1].owner}
                                                work={ProjectsData[i + 1].Work}
                                                description={ProjectsData[i + 1].description}
                                            />
                                        </div>
