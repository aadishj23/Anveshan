        ...
        LinkedInLink && {
            ...
            icon: (
                <img
                    src={Linkedin}
                    alt="Linkedin"
                    className="h-7 w-auto text-neutral-500 dark:text-neutral-300"
                />
            ),
            href: LinkedInLink,
        },
        GithubLink && {
            ...
            icon: (
                <img
                    src={Github}
                    alt="Github"
                    className="h-6 w-auto text-neutral-500 dark:text-neutral-300"
                />
            ),
            href: GithubLink,
        },
    ...
    return (
        <div className="w-64 rounded-lg shadow-2xl shadow-zinc-700 hover:shadow-lg hover:shadow-zinc-600 transition-shadow duration-300 transform hover:scale-105 group bg-[#303030]">
            ...
            <div className="px-6 py-2">
                ...
                {position && <p className="mt-2 text-lg text-gray-300">{position}</p>}
            </div>
