...
const EventsData= [
    ...
    },
    {
        ...
        "description": "Technovation is Anveshan's annual learning series, dedicated to igniting passion and sparking innovation in tech. Over the course of an immersive week, juniors have the unique opportunity to learn from experienced seniors and alumni across multiple domains, including App Development, Open Source, Machine Learning, Web Development, Cloud Computing, and DevOps.This event bridges the gap between theoretical knowledge and practical application, with sessions designed to provide hands-on experience, insider tips, and career guidance directly from those who've walked the path before. Technovation is a platform for juniors to explore emerging technologies, gain clarity on career paths, and connect with mentors who inspire growth and ambition.",
